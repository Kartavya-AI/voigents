      ...
      <section className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="relative bg-blue-600 rounded-2xl lg:rounded-3xl p-8 lg:p-16 overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
              Ready to explore how Voiceflow can help your team? Let's talk.
            </p>
            <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-md font-medium hover:bg-white hover:text-blue-600 transition-colors text-base">
              Sign up free
            </button>
          </div>
        </div>
